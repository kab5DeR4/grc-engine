...
// Componente Header memorizado para optimizar el rendimiento y permitir la personalización visual
const Header = memo(() => {
  const { runScan, scanRunning } = useDemoStore();

  return (
    <header className="h-[60px] flex items-center justify-between px-4 sm:px-8 bg-[#E7E3DA] dark:bg-[#1A1917] hairline-b sticky top-0 z-40 transition-colors">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="px-2.5 py-1 bg-[#DCD7CB] dark:bg-[#2A2825] hairline-all hidden sm:flex items-center gap-2 transition-colors">
        ...
        {/* Selector de tema visual y densidad de interfaz */}
